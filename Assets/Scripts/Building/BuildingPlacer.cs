...
#region Phase 2 Sprint 4 - Building Placer With UI Click Guard
//using UnityEngine;
...
//    void HandleClick()
//    {
//        // Ignore clicks that hit UI elements — prevents popup buttons from also triggering grid clicks
...
public class BuildingPlacer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Mouse.current != null && Mouse.current.leftButton.wasReleasedThisFrame && !cameraController.IsDragging)
            HandleClick();
    }
